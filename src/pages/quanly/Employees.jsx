      ...
      {editing && (
        <div className="nv-form-card">
          ...
          <input
            value={editing.HoTen}
            onChange={(e) =>
              setEditing({ ...editing, HoTen: e.target.value })
            }
          />
          ...
          <input
            value={editing.SDT}
            onChange={(e) =>
              setEditing({ ...editing, SDT: e.target.value })
            }
          />
          ...
          <input
            ...
            onChange={(e) =>
              setEditing({ ...editing, NgSinh: e.target.value })
            }
          />
          ...
          <input
            ...
            onChange={(e) =>
              setEditing({ ...editing, DiaChi: e.target.value })
            }
          />
      ...
      {selected && (
        <div className="nv-modal-overlay">
          <div className="nv-modal">
            ...
            <p><b>Mã QTV:</b> {selected.MaQTV}</p>
            <p><b>Họ tên:</b> {selected.HoTen}</p>
            <p><b>Email:</b> {selected.Email}</p>
            <p><b>SĐT:</b> {selected.SDT}</p>
            <p><b>Giới tính:</b> {selected.GioiTinh}</p>
            <p><b>Ngày sinh:</b> {selected.NgSinh}</p>
            <p><b>Chi nhánh:</b> {selected.TenCN}</p>
            <p><b>Chức vụ:</b> {selected.MaCV}</p>
            <p><b>Địa chỉ:</b> {selected.DiaChi}</p>
            <p>
              <b>Trạng thái:</b>

              {
                selected.TrangThai === 1
                  ? " Đang làm"
                  : " Nghỉ việc"
              }
